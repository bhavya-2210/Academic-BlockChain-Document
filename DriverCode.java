...
public class DriverCode {
	public static void main(String[] args) {
		...
		try
		{
			...
			CRF crf = new CRF(64);
			String corr_dgst = crf.Fn(crf.Fn(crf.Fn("Himanshu_98#Aditya_41")+"#"+crf.Fn("Rishabh_63#Garima_11"))+
					"#"+crf.Fn(crf.Fn("Ramesh_91#Vaibhav_0")+"#"+crf.Fn("Ritika_63#Saiyam_100")));
		...
		try
		{
			...
			CRF crf = new CRF(64);
			String corr_dgst = crf.Fn(crf.Fn(crf.Fn("Himanshu_98#Aditya_41")+"#"+crf.Fn("Rishabh_99#Garima_11"))+"#"+crf.Fn(crf
					.Fn("Ramesh_91#Vaibhav_0")+"#"+crf.Fn("Ritika_63#Saiyam_100")));
			correct &= (corr_dgst.equals(tree.rootnode.val));
			correct &= (corr_dgst.equals(summary));
